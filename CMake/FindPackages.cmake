...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Boost 1.41.0 COMPONENTS program_options system timer date_time serialization unit_test_framework regex)
  ...
  find_package(Boost 1.41.0  REQUIRED program_options system timer date_time serialization unit_test_framework regex)
endif()
...
set(DISPLAYCLUSTER_BUILD_DEBS autoconf;automake;cmake;cppcheck;doxygen;freeglut3-dev;git;git-review;git-svn;lcov;libavcodec-dev;libavformat-dev;libavutil-dev;libboost-all-dev;libfcgi-dev;libjpeg-turbo8-dev;libopenmpi-dev;libpoppler-dev;libswscale-dev;libturbojpeg;libxmu-dev;ninja-build;openmpi-bin;pkg-config;subversion)
