...
common_package(Qt4 4.7  REQUIRED COMPONENTS QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit QtDeclarative)
common_package(Poppler 0.24   COMPONENTS Qt4)
...
if(Qt4_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND DISPLAYCLUSTER_DEPENDENT_LIBRARIES Qt4)
  endif()
...
set(DISPLAYCLUSTER_DEPENDS Boost;Deflect;FCGI;FFMPEG;MPI;OpenGL;Qt4;Poppler;TUIO;OpenMP)
